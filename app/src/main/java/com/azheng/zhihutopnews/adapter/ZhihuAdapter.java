...
import com.azheng.zhihutopnews.MainActivity;
...
import com.azheng.zhihutopnews.uitls.DensityUtil;
import com.azheng.zhihutopnews.uitls.ObservableColorMatrix;
...
public class ZhihuAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements MainActivity.LoadingMore {
    ...
    private void bindViewHolderNormal(final ZhihuViewHolder holder, final int position) {
        ...
        Glide.with(context)
                ...
                //图片的缩放，节约内存。通常情况下，比如图片为100*100像素，如果imageview布局大小为10*10，
                // 系统会加载原尺寸大小，内存浪费。glide不会，它会自动计算布局大小，然后加载相应大小图片
