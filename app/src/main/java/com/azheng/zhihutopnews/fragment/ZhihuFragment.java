...
import com.azheng.zhihutopnews.bean.TopStoryItem;
import com.azheng.zhihutopnews.bean.ZhihuDaily;
import com.azheng.zhihutopnews.config.Config;
import com.azheng.zhihutopnews.presenter.implePresenter.ZhihuPresenterImpl;
import com.azheng.zhihutopnews.presenter.impleView.IZhihuFragment;
import com.azheng.zhihutopnews.view.GridItemDividerDecoration;
import com.azheng.zhihutopnews.widget.MainBanner;
...
public class ZhihuFragment extends BaseFragment implements IZhihuFragment {
    ...
    */
    ...
    private void setHead(RecyclerView view){
        View head = LayoutInflater.from(getContext()).inflate(R.layout.header,null,false);
